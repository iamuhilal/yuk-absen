      ...
      <div class="container p-5 col-4 rounded" style="background-color : white;">
        ...
        <div class="row d-flex justify-content-center">
          ...
          <?php if (isset($errorkey)) : ?>
            <p style="color: red; font-style: italic">absensi tidak tersedia</p>
          <?php endif; ?>
          <?php if (isset($timeout)) : ?>
            <p style="color: red; font-style: italic">abseni sudah selesai</p>
          <?php endif; ?>
          <form action="" method="post">
            <div class="form-group">
              <input type="text" name="absenkey" id="absenkey" class="form-control" placeholder="Masukkan Kode Absensi">
            </div>
            ...
            <div class=" text-center">
              <a href="login.php"><button type="button" class="btn btn-block btn-dark" style="border:none;" >Buat Absen</button></a>
