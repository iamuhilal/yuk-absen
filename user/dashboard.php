  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-2 bg-light d-none d-md-block sidebar">
        <div class="left-sidebar">
          <ul class="nav flex-column sidebar-nav">
            <li class="nav-item">
              <a class="nav-link font-weight-bold" href="#">Make</a>
            </li>
            <li class="nav-item">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <h3 class="text-center">Make Attendance Roll</h3>
        <hr>
        ...
        <div class="mt-5  container">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
              ...
              <label for="nama">Attendance Roll Name</label>
              <input type="text" name="nama" id="nama" class="form-control" placeholder="input name of attendance roll">
            </div>

            <!-- DESCRIPTION -->
            <?php if (isset($desckos)) : ?>
              <p style="color: red; font-style: italic">description empty</p>
            <?php endif; ?>
            <div class="form-group mb-3">
              <span style="color: red;">*</span>
              <label for="desc">Attendance Roll Description</label>
              <textarea type="text" class="form-control" name="desc" id="desc" rows="4" placeholder="input description of attendance roll"></textarea>
            </div>

            <!-- DATE -->
            <?php if (isset($timekos)) : ?>
              <p style="color: red; font-style: italic">deadline empty / its past</p>
            <?php endif; ?>
            <div class="form-group mb-3">
              <span style="color: red;">*</span>
              <label for="time">Attendance Roll Deadline</label><br>
