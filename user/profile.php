        ...
        <div class="mt-5  container">
          <form action="" method="post">
            ...
            <div class="form-group mt-4">
              ...
              <input type="text" name="nama" id="nama" class="form-control mt-2" placeholder="input your name" value="<?php echo $row['nama_user']; ?>">
            </div>
            ...
            <div class="form-group mt-4">
              ...
              <input type="text" name="email" id="email" class="form-control mt-2" placeholder="input your email" value="<?php echo $row['email_user']; ?>">
            </div>
