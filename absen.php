  ...
  <body>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col mr-5">
          <!-- SIGNUP -->
          <h2 class="text-center">Silahkan Isi Absensi</h2>
          <form action="" method="post">
            ...
            <?php if (isset($npmkos)) : ?>
              <p style="color: red; font-style: italic">npm empty</p>
            <?php endif; ?>
            <div class="form-group">
              <label for="npm">NPM</label>
              <input type="text" name="npm" id="npm" class="form-control" placeholder="Input NPM">
            </div>
